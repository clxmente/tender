      ...
      <div className="relative pt-6 pb-16 sm:pb-24">
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block xl:inline"><span className="block text-indigo-600 xl:inline">Select</span> Your Preferences Below</span>{' '}
          </h1>
          <p className="mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            These choices will affect the dishes shown to you. You can customize your preferences by selecting from
            the checkboxes below, then clicking the button at the bottom of the screen.
          </p>
